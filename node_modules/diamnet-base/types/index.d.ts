...
export namespace Operation {
  ...
  interface CreateClaimableBalance
    extends BaseOperation<OperationType.CreateClaimableBalance> {
    amount: string;
    asset: Asset;
    claimants: Claimant[];
  }
  ...
  interface ClaimClaimableBalance
    extends BaseOperation<OperationType.ClaimClaimableBalance> {
    balanceId: string;
  }
  ...
  interface BeginSponsoringFutureReserves
    extends BaseOperation<OperationType.BeginSponsoringFutureReserves> {
    sponsoredId: string;
  }
  ...
  interface EndSponsoringFutureReserves
    extends BaseOperation<OperationType.EndSponsoringFutureReserves> {}
  function endSponsoringFutureReserves(
    options: OperationOptions.BaseOptions
  ): xdr.Operation<EndSponsoringFutureReserves>;

  interface RevokeAccountSponsorship
    extends BaseOperation<OperationType.RevokeSponsorship> {
    account: string;
  }
  ...
  interface RevokeTrustlineSponsorship
    extends BaseOperation<OperationType.RevokeSponsorship> {
    account: string;
    asset: Asset | LiquidityPoolId;
  }
  ...
  interface RevokeOfferSponsorship
    extends BaseOperation<OperationType.RevokeSponsorship> {
    seller: string;
    offerId: string;
  }
  ...
  interface RevokeDataSponsorship
    extends BaseOperation<OperationType.RevokeSponsorship> {
    account: string;
    name: string;
  }
  ...
  interface RevokeSignerSponsorship
    extends BaseOperation<OperationType.RevokeSponsorship> {
    account: string;
    signer: SignerKeyOptions;
  }
  ...
  interface ClawbackClaimableBalance
    extends BaseOperation<OperationType.ClawbackClaimableBalance> {
    balanceId: string;
  }
  ...
  interface SetTrustLineFlags
    extends BaseOperation<OperationType.SetTrustLineFlags> {
    trustor: string;
    asset: Asset;
    flags: {
      authorized?: boolean;
  ...
  interface LiquidityPoolDeposit
    extends BaseOperation<OperationType.LiquidityPoolDeposit> {
    liquidityPoolId: string;
    maxAmountA: string;
    maxAmountB: string;
    minPrice: string;
  ...
  interface LiquidityPoolWithdraw
    extends BaseOperation<OperationType.LiquidityPoolWithdraw> {
    liquidityPoolId: string;
    amount: string;
    minAmountA: string;
    minAmountB: string;
  ...
  interface InvokeHostFunction
    extends BaseOperation<OperationType.InvokeHostFunction> {
    func: xdr.HostFunction;
    auth?: xdr.SorobanAuthorizationEntry[];
  }
  ...
  interface ExtendFootprintTTL
    extends BaseOperation<OperationType.ExtendFootprintTTL> {
    extendTo: number;
  }

  function restoreFootprint(
    options: OperationOptions.RestoreFootprint
  ): xdr.Operation<RestoreFootprint>;
  interface RestoreFootprint
    extends BaseOperation<OperationType.RestoreFootprint> {}
...
export function decodeAddressToMuxedAccount(
  address: string,
...
export namespace cereal {
  // These belong in diamante-js-xdr but that would be a huge lift since we'd
