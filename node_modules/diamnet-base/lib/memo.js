 ...
 * @see [Transactions concept](https://developers.diamcircle.io/#/glossary/glossary?id=transaction)
 * @class Memo
 */
  ...
  return _createClass(Memo, [{
    ...
    function toXDRObject() {
      switch (this._type) {
        ...
        case MemoID:
          return _xdr["default"].Memo.memoId(_diamanteJsXdr.UnsignedHyper.fromString(this._value));
        case MemoText:
