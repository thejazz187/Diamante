 ...
 *
 * @constant
 * @see [Account flags](https://developers.diamcircle.io/#/glossary/glossary?id=flags)
 */
 ...
 * [operations](https://developers.diamcircle.io/#/glossary/glossary?id=operation) in
 * Diamante network.
 *
...
var Operation = exports.Operation = /*#__PURE__*/function () {
  ...
  return _createClass(Operation, null, [{
        ...
        case 'setOptions':
          {
            ...
            // home_domain is checked by iscntrl in Diamante-Net-Core
        ...
        case 'manageData':
          {
            ...
            // manage_data.name is checked by iscntrl in Diamante-Net-Core
    ...
    /**
     * Validates that a given amount is possible for a Diamante asset.
     *
     ...
     * towards validating the standard Diamante operations.
     *
    ...
    value: function _toXDRAmount(value) {
      ...
      return _diamanteJsXdr.Hyper.fromString(amount.toString());
    }
