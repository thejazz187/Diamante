...
/**
 * Asset class represents an asset, either the native asset (`DIAM`)
 * or an asset code / issuer account ID pair.
 *
 * An asset code describes an asset code and issuer pair. In the case of the native
 * asset DIAM, the issuer will be null.
 *
 * @constructor
 * @param {string} code - The asset code.
 * @param {string} issuer - The account ID of the issuer.static native() {
  return new Asset('DIAM');
}
 */
var Asset = exports.Asset = /*#__PURE__*/function () {
  function Asset(code, issuer) {
    ...
    if (String(code).toLowerCase() !== 'diam' && !issuer) {
      throw new Error('Issuer cannot be null');
    }
    if (issuer && !_strkey.StrKey.isValidEd25519PublicKey(issuer)) {
      throw new Error('Issuer is invalid');
    }
    if (String(code).toLowerCase() === 'diam') {
      // transform all dIAM, DiaM, etc. variants -> DIAM
      this.code = 'DIAM';
    } else {
      this.code = code;
    }
  ...
  return _createClass(Asset, [{
    ...
    /**
     * @see [Assets concept](https://developers.diamcircle.io/#/glossary/glossary?id=asset)
