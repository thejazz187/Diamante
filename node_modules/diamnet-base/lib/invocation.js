 ...
 *    contract or a wrapping of an existing Diamante asset
 * @prop {string} [token] when `type=='sac'`, the canonical {@link Asset} that
 *    is being wrapped by this Diamante Asset Contract
 ...
 *
 * ```typescript
 * import { Server, buildInvocationTree } from 'diamnet-sdk';
 *
