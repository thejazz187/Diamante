...
/**
 * Converts a Diamante address (in G... or M... form) to an `xdr.MuxedAccount`
...
/**
 * Transform a Diamante address (G...) and an ID into its XDR representation.
 *
 * @param  {string} address   - a Diamante G... address
...
function encodeMuxedAccount(address, id) {
  if (!_strkey.StrKey.isValidEd25519PublicKey(address)) {
    throw new Error('address should be a Diamante account ID (G...)');
  }
  if (typeof id !== 'string') {
 ...
 * @return {string} a Diamante public key address (G...)
 */
