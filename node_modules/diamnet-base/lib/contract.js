 ...
 *
 * `Contract` represents a single contract in the Diamante network, embodying the
 * interface of the contract. See
 * for more information about how contracts work in Diamante.
 *
 * @constructor
 *
...
var Contract = exports.Contract = /*#__PURE__*/function () {
  ...
  /**
   * Returns Diamante contract ID as a strkey, ex.
   * `CA3D5KRYM6CB7OWQ6TWYRR3Z4T7GNZLKERYNZGGA5SOAOPIFY6YQGAXE`.
   * @returns {string}
   */
