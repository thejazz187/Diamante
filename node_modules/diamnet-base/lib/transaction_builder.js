 ...
 *
 * @constant
 * @see [Fees](https://developers.diamcircle.io/#/glossary/glossary?id=transaction-fee)
 */
 ...
 * @see [Timeout](https://developers.diamcircle.io/#/api-reference/accounts?id=transactions)
 */
 ...
 * a transaction, `diamnet-sdk` automatically increments the source account's
 ...
 *     amount: "100",
 *     asset: Asset.native()
 * })) // <- sends 100 DIAM to destinationB
 * .setTimeout(30)
 * .build();
 *
...
var TransactionBuilder = exports.TransactionBuilder = /*#__PURE__*/function () {
  ...
  return _createClass(TransactionBuilder, [{
     ...
     *     network (e.g. "Diamante MainNet; SEP 2022").
     *
     * @returns {TransactionBuilder}
     */
  }, {
     ...
     *     Diamante network (e.g. "Diamante MainNet; SEP 2022",
     *     see {@link Networks})
     *
     ...
     * @see  https://developers.diamcircle.io/#/encyclopedia/fee-bump-transactions
     *
