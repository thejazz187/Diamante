...
/**
 * Returns an operation that wraps a Diamante asset into a token contract.
 *
 * @function
 * @alias Operation.createStellarAssetContract
 *
 * @param {any}          opts - the set of parameters
 * @param {Asset|string} opts.asset - the Diamante asset to wrap, either as an
 *    {@link Asset} object or in canonical form (DEP-11, `code:issuer`)
 * @param {xdr.SorobanAuthorizationEntry[]} [opts.auth] - an optional list
 *    outlining the tree of authorizations required for the call
 * @param {string} [opts.source] - an optional source account
 *
...
function createStellarAssetContract(opts) {
  ...
  if (typeof asset === 'string') {
    ...
    asset = new _asset.Asset(code, issuer); // handles 'diam' by default
  }
