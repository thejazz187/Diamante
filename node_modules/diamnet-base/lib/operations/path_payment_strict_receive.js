 ...
 * The transfer optionally occurs through a path. DIAM payments create the
 * destination account if it does not exist.
 *
 * @function
 * @alias Operation.pathPaymentStrictReceive
 * @see https://developers.diamcircle.io/#/fundamentals/operations?id=path-payment-strict-receive
 *
