 ...
 * through a path. DIAM payments create the destination account if it does not
 * exist.
 *
 * @function
 * @alias Operation.pathPaymentStrictSend
 * @see https://developers.diamcircle.io/#/fundamentals/operations?id=path-payment-strict-send
 *
