...
/**
 * StrKey is a helper class that allows encoding and decoding Diamante keys
...
var StrKey = exports.StrKey = /*#__PURE__*/function () {
  ...
  return _createClass(StrKey, null, [{
    ...
    /**
     * Returns true if the given Diamante public key is a valid ed25519 public key.
    ...
    /**
     * Returns true if the given Diamante secret key is a valid ed25519 secret seed.
    ...
    /**
     * Returns true if the given Diamante public key is a valid med25519 public key.
     * @param {string} publicKey public key to check
     * @returns {boolean}
     */
  }, {
