 ...
 *
 * @see [All Accounts](https://developers.diamcircle.io/#/fundamentals/accounts?id=accounts-in-diamante)
 * @class AccountCallBuilder
 * @augments CallBuilder
 * @class
 * @param {string} serverUrl Aurora server URL.
 */
export declare class AccountCallBuilder extends CallBuilder<ServerApi.CollectionPage<ServerApi.AccountRecord>> {
     ...
     * @see [Accounts](https://developers.diamcircle.io/#/fundamentals/accounts?id=accounts-in-diamante)
     * @param {string} id For example: `GDGQVOKHW4VEJRU2TETD6DBRKEO5ERCNF353LW5WBFW3JJWQ2BRQ6KDD`
