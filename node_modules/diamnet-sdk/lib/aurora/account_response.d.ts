 ...
 *
 * @see [Account Details](https://developers.diamcircle.io/#/fundamentals/accounts?id=accounts-in-diamante)
 * @param {string} response Response from aurora account endpoint.
...
export declare class AccountResponse {
    ...
    readonly thresholds: AuroraApi.AccountThresholds;
    readonly flags: AuroraApi.Flags;
    readonly balances: AuroraApi.BalanceLine[];
    ...
    /**
     * Get Diamante account public key ex. `GB3KJPLFUYN5VL6R3GU3EGCGVCKFDSD7BEDX42HWG5BWFKB3KQGJJRMA`
