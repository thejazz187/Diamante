...
var _aurora_axios_client = _interopRequireWildcard(require("./aurora_axios_client"));
...
var JOTS_IN_DIAM = 10000000;
var ACCOUNT_REQUIRES_MEMO = "MQ==";
function getAmountInDiam(amt) {
  return new _bignumber.default(amt).div(JOTS_IN_DIAM).toString();
}
var Server = exports.Server = function () {
  function Server(serverURL) {
    ...
    if (Object.keys(customHeaders).length > 0) {
      _aurora_axios_client.default.interceptors.request.use(function (config) {
        config.headers = Object.assign(config.headers, customHeaders);
        return config;
      });
    }
    if (this.serverURL.protocol() !== "https" && !allowHttp) {
      throw new Error("Cannot connect to insecure aurora server");
    }
  }
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              currentTime = (0, _aurora_axios_client.getCurrentServerTime)(this.serverURL.hostname());
              if (!currentTime) {
                _context.next = 4;
                break;
              }
            ...
            case 6:
              _context.next = 8;
              return _aurora_axios_client.default.get((0, _urijs.default)(this.serverURL).toString());
            case 8:
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              return _context4.abrupt("return", _aurora_axios_client.default.post((0, _urijs.default)(this.serverURL).segment("transactions").toString(), "tx=".concat(tx), {
                timeout: SUBMIT_TRANSACTION_TIMEOUT
              }).then(function (response) {
                if (!response.data.result_xdr) {
                  return response.data;
                }
                var responseXDR = _diamnetBase.xdr.TransactionResult.fromXDR(response.data.result_xdr, "base64");
                  ...
                  offerResults = results.map(function (result, i) {
                    ...
                    var offersClaimed = offerSuccess.offersClaimed().map(function (offerClaimedAtom) {
                      ...
                      switch (offerClaimedAtom.switch()) {
                        case _diamnetBase.xdr.ClaimAtomType.claimAtomTypeV0():
                          sellerId = _diamnetBase.StrKey.encodeEd25519PublicKey(offerClaimed.sellerEd25519());
                          break;
                        case _diamnetBase.xdr.ClaimAtomType.claimAtomTypeOrderBook():
                          sellerId = _diamnetBase.StrKey.encodeEd25519PublicKey(offerClaimed.sellerId().ed25519());
                          break;
                        default:
                      ...
                      var sold = _diamnetBase.Asset.fromOperation(offerClaimed.assetSold());
                      var bought = _diamnetBase.Asset.fromOperation(offerClaimed.assetBought());
                      var assetSold = {
                      ...
                      return {
                        ...
                        assetSold: assetSold,
                        amountSold: getAmountInDiam(claimedOfferAmountSold),
                        assetBought: assetBought,
                        amountBought: getAmountInDiam(claimedOfferAmountBought)
                      };
                    });
                    ...
                    if (typeof offerSuccess.offer().value === "function" && offerSuccess.offer().value()) {
                      ...
                      currentOffer = {
                        ...
                        selling: {},
                        buying: {},
                        amount: getAmountInDiam(offerXDR.amount().toString()),
                        price: {
                          n: offerXDR.price().n(),
                          d: offerXDR.price().d()
                        }
                      };
                      var selling = _diamnetBase.Asset.fromOperation(offerXDR.selling());
                      currentOffer.selling = {
                        type: selling.getAssetType(),
                        assetCode: selling.getCode(),
                        issuer: selling.getIssuer()
                      };
                      var buying = _diamnetBase.Asset.fromOperation(offerXDR.buying());
                      currentOffer.buying = {
                    ...
                    return {
                      ...
                      amountBought: getAmountInDiam(amountBought),
                      amountSold: getAmountInDiam(amountSold),
      ...
      var _submitAsyncTransaction = _asyncToGenerator(_regeneratorRuntime().mark(function _callee5(transaction) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 4:
              tx = encodeURIComponent(transaction.toEnvelope().toXDR().toString("base64"));
              return _context5.abrupt("return", _aurora_axios_client.default.post((0, _urijs.default)(this.serverURL).segment("transactions_async").toString(), "tx=".concat(tx)).then(function (response) {
                return response.data;
              }).catch(function (response) {
                if (response instanceof Error) {
                  return Promise.reject(response);
      ...
      var _checkMemoRequired = _asyncToGenerator(_regeneratorRuntime().mark(function _callee7(transaction) {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              if (transaction instanceof _diamnetBase.FeeBumpTransaction) {
