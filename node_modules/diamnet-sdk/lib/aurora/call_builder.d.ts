 ...
 * @param {string} serverUrl URL of Aurora server
 * @class CallBuilder
 */
export declare class CallBuilder<T extends AuroraApi.FeeStatsResponse | AuroraApi.BaseResponse | ServerApi.CollectionPage<AuroraApi.BaseResponse>> {
    protected url: URI;
    filter: string[][];
