...
export interface BaseEffectRecord extends AuroraApi.BaseResponse {
    id: string;
    account: string;
    paging_token: string;
    type_i: EffectType;
...
export interface ClaimableBalanceClawedBack extends AuroraApi.BaseResponse {
    balance_id: string;
}
export interface LiquidityPoolEffectRecord extends AuroraApi.BaseResponse {
    id: string;
    fee_bp: number;
