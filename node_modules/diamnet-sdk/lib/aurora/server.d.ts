import { Asset, FeeBumpTransaction, Transaction } from "diamnet-base";
 ...
 * @class
 * @param {string} serverURL Aurora Server URL (ex. `https://diamtestnet.diamcircle.io`).
...
export declare class Server {
    /**
     * serverURL Aurora Server URL (ex. `https://diamtestnet.diamcircle.io`).
     *
     ...
     * your machine's local time could be different from Aurora's. This gives you
     ...
     *
     * ```javascript
     * const transaction = new DiamSdk.TransactionBuilder(accountId, {
     *  fee: await DiamSdk.Server.fetchBaseFee(),
     *  timebounds: await DiamSdk.Server.fetchTimebounds(100)
     * })
     ...
     * This is to avoid a scenario where Aurora is horking up the wrong date.
     ...
     * @returns {Promise<AuroraApi.FeeStatsResponse>} Promise that resolves to the fee stats returned by Aurora.
     */
    feeStats(): Promise<AuroraApi.FeeStatsResponse>;
    /**
     ...
     * aurora.
     */
    submitTransaction(transaction: Transaction | FeeBumpTransaction, opts?: Server.SubmitTransactionOptions): Promise<AuroraApi.SubmitTransactionResponse>;
    /**
     * Submits an asynchronous transaction to the network. Unlike the synchronous version, which blocks
     * and waits for the transaction to be ingested in Aurora, this endpoint relays the response from
     ...
     * aurora.
     */
    submitAsyncTransaction(transaction: Transaction | FeeBumpTransaction, opts?: Server.SubmitTransactionOptions): Promise<AuroraApi.SubmitAsyncTransactionResponse>;
    /**
     * @returns {AccountCallBuilder} New {@link AccountCallBuilder} object configured by a current Aurora server configuration.
     */
    accounts(): AccountCallBuilder;
    /**
     * @returns {ClaimableBalanceCallBuilder} New {@link ClaimableBalanceCallBuilder} object configured by a current Aurora server configuration.
     */
    claimableBalances(): ClaimableBalanceCallBuilder;
    /**
     * @returns {LedgerCallBuilder} New {@link LedgerCallBuilder} object configured by a current Aurora server configuration.
     */
    ledgers(): LedgerCallBuilder;
    /**
     * @returns {TransactionCallBuilder} New {@link TransactionCallBuilder} object configured by a current Aurora server configuration.
     */
    transactions(): TransactionCallBuilder;
    /**
     * People on the Diamante network can make offers to buy or sell assets. This endpoint represents all the offers on the DEX.
     *
     ...
     * @returns {OrderbookCallBuilder} New {@link OrderbookCallBuilder} object configured by a current Aurora server configuration.
     */
    orderbook(selling: Asset, buying: Asset): OrderbookCallBuilder;
    /**
     * Returns
     * @returns {TradesCallBuilder} New {@link TradesCallBuilder} object configured by a current Aurora server configuration.
     */
    trades(): TradesCallBuilder;
    /**
     * @returns {OperationCallBuilder} New {@link OperationCallBuilder} object configured by a current Aurora server configuration.
     */
    operations(): OperationCallBuilder;
    /**
     * @returns {LiquidityPoolCallBuilder} New {@link LiquidityPoolCallBuilder}
     *     object configured to the current Aurora server settings.
     */
    liquidityPools(): LiquidityPoolCallBuilder;
    /**
     * The Diamante Network allows payments to be made between assets through path
     ...
     *
     * As part of the search, auroa will load a list of assets available to the
     ...
     * amount.
     *
     * If a list of assets is passed as the source, aurora will find any payment
     ...
     * @returns {StrictReceivePathCallBuilder} New {@link StrictReceivePathCallBuilder} object configured with the current Aurora server configuration.
     */
    strictReceivePaths(source: string | Asset[], destinationAsset: Asset, destinationAmount: string): PathCallBuilder;
    /**
     * The Diamante Network allows payments to be made between assets through path payments. A strict send path payment specifies a
     ...
     * @returns {StrictSendPathCallBuilder} New {@link StrictSendPathCallBuilder} object configured with the current Aurora server configuration.
     */
    ...
    /**
     * @param {string} address The Diamante ID that you want Friendbot to send diams to
     ...
     * Returns new {@link TradeAggregationCallBuilder} object configured with the current Aurora server configuration.
     ...
     * [SEP-29](https://.org/protocol/sep-29). It will load each account
