 ...
 *
 * @see [Claimable Balances](https://developers.diamcircle.io/#/encyclopedia/claimable-balances?id=claimable-balances)
...
export declare class ClaimableBalanceCallBuilder extends CallBuilder<ServerApi.CollectionPage<ServerApi.ClaimableBalanceRecord>> {
     ...
     *
     * @see [Claimable Balance Details](https://developers.diamcircle.io/#/encyclopedia/claimable-balances?id=claimable-balances)
