...
var _aurora_axios_client = require("./aurora_axios_client");
...
var CallBuilder = exports.CallBuilder = function () {
  ...
  return _createClass(CallBuilder, [{
    ...
    value: function stream() {
      ...
      this.checkFilter();
      this.url.setQuery("X-Client-Name", "js-diamnet-sdk");
      this.url.setQuery("X-Client-Version", _aurora_axios_client.version);
      var es;
      var timeout;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _context3.abrupt("return", _aurora_axios_client.AxiosClient.get(url.toString()).then(function (response) {
