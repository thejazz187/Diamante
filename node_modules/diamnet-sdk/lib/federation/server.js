  ...
  return _createClass(FederationServer, [{
    ...
    value: (function () {
      var _resolveAddress = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(address) {
        var diamanteAddress, url;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              diamanteAddress = address;
              ...
              return _context.abrupt("return", Promise.reject(new Error("Unknown domain. Make sure `address` contains a domain (ex. `bob*diamcircle.io`) or pass `domain` parameter when instantiating the server object.")));
            case 4:
              diamanteAddress = "".concat(address, "*").concat(this.domain);
            case 5:
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              if (_diamnetBase.StrKey.isValidEd25519PublicKey(value)) {
                _context5.next = 4;
                break;
              }
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 3:
              ...
              return _context6.abrupt("return", Promise.reject(new Error("diamante.toml does not contain FEDERATION_SERVER field")));
            case 6:
