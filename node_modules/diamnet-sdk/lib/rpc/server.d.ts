...
import { Account, Address, Contract, FeeBumpTransaction, Transaction, xdr } from "diamnet-base";
import { Api } from "./api";
...
export declare class Server {
     ...
     * const contract = new DiamSdk.Contract(contractId);
     *
     * // Right now, this is just the default fee for this example.
     * const fee = DiamSdk.BASE_FEE;
     * const transaction = new DiamSdk.TransactionBuilder(account, { fee })
     *   // Uncomment the following line to build transactions for the live network. Be
     *   // sure to also change the aurora hostname.
     *   //.setNetworkPassphrase(DiamSdk.Networks.PUBLIC)
     *   .setNetworkPassphrase(DiamSdk.Networks.FUTURENET)
     ...
     * // as explained above (look for DiamSdk.Network).
     * const sourceKeypair = DiamSdk.Keypair.fromSecret(sourceSecretKey);
     ...
     * });
     */
    prepareTransaction(tx: Transaction | FeeBumpTransaction): Promise<Transaction<import("diamnet-base").Memo<import("diamnet-base").MemoType>, import("diamnet-base").Operation[]>>;
    /**
     * Submit a real transaction to the Diamante network.
     *
     * Unlike Aurora, Soroban RPC does not wait for transaction completion. It
