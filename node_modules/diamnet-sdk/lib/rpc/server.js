...
function findCreatedAccountSequenceInTransactionMeta(meta) {
  ...
  var sequenceNumber = (_operations$flatMap$f = operations.flatMap(function (op) {
    ...
    return c.switch() === _diamnetBase.xdr.LedgerEntryChangeType.ledgerEntryCreated() && c.created().data().switch() === _diamnetBase.xdr.LedgerEntryType.account();
      ...
      var _getAccount = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(address) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ledgerKey = _diamnetBase.xdr.LedgerKey.account(new _diamnetBase.xdr.LedgerKeyAccount({
                accountId: _diamnetBase.Keypair.fromPublicKey(address).xdrPublicKey()
              }));
              _context.next = 3;
            ...
            case 6:
              ...
              return _context.abrupt("return", new _diamnetBase.Account(address, accountEntry.seqNum().toString()));
            case 8:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              scAddress = new _diamnetBase.Contract(contract).address().toScAddress();
              _context3.next = 14;
              break;
            case 5:
              if (!(contract instanceof _diamnetBase.Address)) {
                _context3.next = 9;
                break;
              }
              ...
              break;
            case 9:
              if (!(contract instanceof _diamnetBase.Contract)) {
                _context3.next = 13;
                break;
              }
            ...
            case 14:
              ...
              break;
            case 17:
              xdrDurability = _diamnetBase.xdr.ContractDataDurability.temporary();
              return _context3.abrupt("break", 22);
            case 19:
              xdrDurability = _diamnetBase.xdr.ContractDataDurability.persistent();
              return _context3.abrupt("break", 22);
            case 21:
              throw new TypeError("invalid durability: ".concat(durability));
            case 22:
              contractKey = _diamnetBase.xdr.LedgerKey.contractData(new _diamnetBase.xdr.LedgerKeyContractData({
                key: key,
                contract: scAddress,
              ...
              return _context3.abrupt("return", this.getLedgerEntries(contractKey).then(function (r) {
                if (r.entries.length === 0) {
                  return Promise.reject({
                    code: 404,
                    message: "Contract data not found. Contract: ".concat(_diamnetBase.Address.fromScAddress(scAddress).toString(), ", Key: ").concat(key.toXDR("base64"), ", Durability: ").concat(durability)
                  });
                }
                return r.entries[0];
              }));
      ...
      var _getContractWasmByContractId = _asyncToGenerator(_regeneratorRuntime().mark(function _callee4(contractId) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              contractLedgerKey = new _diamnetBase.Contract(contractId).getFootprint();
              _context4.next = 3;
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              ledgerKeyWasmHash = _diamnetBase.xdr.LedgerKey.contractCode(new _diamnetBase.xdr.LedgerKeyContractCode({
                hash: wasmHashBuffer
              }));
              _context5.next = 5;
            ...
            case 0:
              return _context8.abrupt("return", this._getTransaction(hash).then(function (raw) {
                ...
                if (raw.status !== _api.Api.GetTransactionStatus.NOT_FOUND) {
                  ...
                  var meta = _diamnetBase.xdr.TransactionMeta.fromXDR(raw.resultMetaXdr, "base64");
                  foundInfo = _objectSpread({
                    ledger: raw.ledger,
                    createdAt: raw.createdAt,
                    applicationOrder: raw.applicationOrder,
                    feeBump: raw.feeBump,
                    envelopeXdr: _diamnetBase.xdr.TransactionEnvelope.fromXDR(raw.envelopeXdr, "base64"),
                    resultXdr: _diamnetBase.xdr.TransactionResult.fromXDR(raw.resultXdr, "base64"),
                    resultMetaXdr: meta
        ...
        return _regeneratorRuntime().wrap(function _callee19$(_context19) {
          while (1) switch (_context19.prev = _context19.next) {
            ...
            case 12:
              ...
              meta = _diamnetBase.xdr.TransactionMeta.fromXDR(response.data.result_meta_xdr, "base64");
              sequence = findCreatedAccountSequenceInTransactionMeta(meta);
              return _context19.abrupt("return", new _diamnetBase.Account(account, sequence));
            case 18:
              _context19.prev = 18;
