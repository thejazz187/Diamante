import { FeeBumpTransaction, Keypair, Transaction } from "diamnet-base";
import { ServerApi } from "../aurora/server_api";
/**
 ...
 * const account = new DiamSdk.Account(keypair.publicKey(), "-1");
 *
 ...
 * const account = new DiamSdk.Account(keypair1.publicKey(), "-1");
 *
 * const transaction = new TransactionBuilder(account, { fee: 100 })
 *    .setTimeout(30)
 *    .build();
