  ...
  function AssembledTransaction(options) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 17:
            ...
            contract = new _diamnetBase.Contract(_this.options.contractId);
            _this.raw = new _diamnetBase.TransactionBuilder(account, {
              fee: (_this$options$fee = _this.options.fee) !== null && _this$options$fee !== void 0 ? _this$options$fee : _diamnetBase.BASE_FEE,
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            _this.built = _diamnetBase.TransactionBuilder.cloneFrom(_this.built, {
              fee: _this.built.fee,
          ...
          case 13:
            ...
            _this.signed = _diamnetBase.TransactionBuilder.fromXDR(signature, _this.options.networkPassphrase);
          case 15:
          case "end":
    ...
    _defineProperty(this, "getStorageExpiration", _asyncToGenerator(_regeneratorRuntime().mark(function _callee4() {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _this.server.getLedgerEntries(new _diamnetBase.Contract(_this.options.contractId).getFootprint());
          case 2:
    ...
    _defineProperty(this, "needsNonInvokerSigningBy", function () {
      ...
      return _toConsumableArray(new Set(((_rawInvokeHostFunctio = rawInvokeHostFunctionOp.auth) !== null && _rawInvokeHostFunctio !== void 0 ? _rawInvokeHostFunctio : []).filter(function (entry) {
        return entry.credentials().switch() === _diamnetBase.xdr.SorobanCredentialsType.sorobanCredentialsAddress() && (includeAlreadySigned || entry.credentials().address().signature().switch().name === "scvVoid");
      }).map(function (entry) {
        return _diamnetBase.StrKey.encodeEd25519PublicKey(entry.credentials().address().address().accountId().ed25519());
      })));
    });
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 15:
            ...
            if (!(entry.credentials().switch() !== _diamnetBase.xdr.SorobanCredentialsType.sorobanCredentialsAddress())) {
              _context6.next = 19;
              break;
            }
            return _context6.abrupt("continue", 32);
          case 19:
            pk = _diamnetBase.StrKey.encodeEd25519PublicKey(entry.credentials().address().address().accountId().ed25519());
            if (!(pk !== publicKey)) {
              _context6.next = 22;
              break;
            }
            return _context6.abrupt("continue", 32);
          case 22:
            _context6.t0 = _diamnetBase.authorizeEntry;
            _context6.t1 = entry;
  ...
  return _createClass(AssembledTransaction, [{
    ...
    get: function get() {
      ...
      this.simulationResult = (_simulation$result = simulation.result) !== null && _simulation$result !== void 0 ? _simulation$result : {
        auth: [],
        retval: _diamnetBase.xdr.ScVal.scvVoid()
      };
    ...
    value: function fromJSON(options, _ref12) {
      ...
      txn.built = _diamnetBase.TransactionBuilder.fromXDR(tx, options.networkPassphrase);
      txn.simulationResult = {
        auth: simulationResult.auth.map(function (a) {
          return _diamnetBase.xdr.SorobanAuthorizationEntry.fromXDR(a, "base64");
        }),
        retval: _diamnetBase.xdr.ScVal.fromXDR(simulationResult.retval, "base64")
      };
      txn.simulationTransactionData = _diamnetBase.xdr.SorobanTransactionData.fromXDR(simulationTransactionData, "base64");
      return txn;
    }
  }, {
    key: "fromXDR",
    value: function fromXDR(options, encodedXDR, spec) {
      var _operation$func;
      var envelope = _diamnetBase.xdr.TransactionEnvelope.fromXDR(encodedXDR, "base64");
      var built = _diamnetBase.TransactionBuilder.fromXDR(envelope, options.networkPassphrase);
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              contract = new _diamnetBase.Contract(options.contractId);
              _context9.next = 4;
              return (0, _utils.getAccount)(options, tx.server);
            case 4:
              account = _context9.sent;
              tx.raw = new _diamnetBase.TransactionBuilder(account, {
                fee: (_options$fee = options.fee) !== null && _options$fee !== void 0 ? _options$fee : _diamnetBase.BASE_FEE,
          ...
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              ...
              tx.raw = new _diamnetBase.TransactionBuilder(account, {
                fee: fee,
                networkPassphrase: options.networkPassphrase
              }).setSorobanData(sorobanData instanceof _diamnetBase.SorobanDataBuilder ? sorobanData.build() : sorobanData).addOperation(_diamnetBase.Operation.restoreFootprint({})).setTimeout((_options$timeoutInSec2 = options.timeoutInSeconds) !== null && _options$timeoutInSec2 !== void 0 ? _options$timeoutInSec2 : _types.DEFAULT_TIMEOUT);
              _context10.next = 4;
              return tx.simulate({
                restore: false
              });
