...
exports.Spec = void 0;
var _diamnetBase = require("diamnet-base");
...
function findCase(name) {
  return function matches(entry) {
    switch (entry.switch().value) {
      case _diamnetBase.xdr.ScSpecUdtUnionCaseV0Kind.scSpecUdtUnionCaseTupleV0().value:
        {
          var tuple = entry.tupleCase();
          return tuple.name().toString() === name;
        }
      case _diamnetBase.xdr.ScSpecUdtUnionCaseV0Kind.scSpecUdtUnionCaseVoidV0().value:
        {
...
function stringToScVal(str, ty) {
  switch (ty.value) {
    case _diamnetBase.xdr.ScSpecType.scSpecTypeString().value:
      return _diamnetBase.xdr.ScVal.scvString(str);
    case _diamnetBase.xdr.ScSpecType.scSpecTypeSymbol().value:
      return _diamnetBase.xdr.ScVal.scvSymbol(str);
    case _diamnetBase.xdr.ScSpecType.scSpecTypeAddress().value:
      {
        var addr = _diamnetBase.Address.fromString(str);
        return _diamnetBase.xdr.ScVal.scvAddress(addr.toScAddress());
      }
    case _diamnetBase.xdr.ScSpecType.scSpecTypeU64().value:
      return new _diamnetBase.XdrLargeInt("u64", str).toScVal();
    case _diamnetBase.xdr.ScSpecType.scSpecTypeI64().value:
      return new _diamnetBase.XdrLargeInt("i64", str).toScVal();
    case _diamnetBase.xdr.ScSpecType.scSpecTypeU128().value:
      return new _diamnetBase.XdrLargeInt("u128", str).toScVal();
    case _diamnetBase.xdr.ScSpecType.scSpecTypeI128().value:
      return new _diamnetBase.XdrLargeInt("i128", str).toScVal();
    case _diamnetBase.xdr.ScSpecType.scSpecTypeU256().value:
      return new _diamnetBase.XdrLargeInt("u256", str).toScVal();
    case _diamnetBase.xdr.ScSpecType.scSpecTypeI256().value:
      return new _diamnetBase.XdrLargeInt("i256", str).toScVal();
    case _diamnetBase.xdr.ScSpecType.scSpecTypeBytes().value:
    case _diamnetBase.xdr.ScSpecType.scSpecTypeBytesN().value:
      return _diamnetBase.xdr.ScVal.scvBytes(Buffer.from(str, "base64"));
    default:
...
function typeRef(typeDef) {
  ...
  var ref;
  switch (value) {
    case _diamnetBase.xdr.ScSpecType.scSpecTypeVal().value:
      {
        ref = "Val";
        break;
      }
    case _diamnetBase.xdr.ScSpecType.scSpecTypeBool().value:
      {
        return {
          type: "boolean"
        };
      }
    case _diamnetBase.xdr.ScSpecType.scSpecTypeVoid().value:
      {
        return {
          type: "null"
        };
      }
    case _diamnetBase.xdr.ScSpecType.scSpecTypeError().value:
      {
        ref = "Error";
        break;
      }
    case _diamnetBase.xdr.ScSpecType.scSpecTypeU32().value:
      {
        ref = "U32";
        break;
      }
    case _diamnetBase.xdr.ScSpecType.scSpecTypeI32().value:
      {
        ref = "I32";
        break;
      }
    ...
    case _diamnetBase.xdr.ScSpecType.scSpecTypeTimepoint().value:
      {
        throw new Error("Timepoint type not supported");
        ref = "Timepoint";
        break;
      }
    case _diamnetBase.xdr.ScSpecType.scSpecTypeDuration().value:
      {
    ...
    case _diamnetBase.xdr.ScSpecType.scSpecTypeOption().value:
      {
        var opt = typeDef.option();
        return typeRef(opt.valueType());
      }
    case _diamnetBase.xdr.ScSpecType.scSpecTypeResult().value:
      {
        break;
      }
    case _diamnetBase.xdr.ScSpecType.scSpecTypeVec().value:
      {
        var arr = typeDef.vec();
    ...
    case _diamnetBase.xdr.ScSpecType.scSpecTypeMap().value:
      {
        var map = typeDef.map();
    ...
    case _diamnetBase.xdr.ScSpecType.scSpecTypeTuple().value:
      {
    ...
    case _diamnetBase.xdr.ScSpecType.scSpecTypeUdt().value:
      {
        var udt = typeDef.udt();
...
function isRequired(typeDef) {
  return typeDef.switch().value !== _diamnetBase.xdr.ScSpecType.scSpecTypeOption().value;
}
...
function functionToJsonSchema(func) {
  ...
  var output = outputs.length > 0 ? typeRef(outputs[0]) : typeRef(_diamnetBase.xdr.ScSpecTypeDef.scSpecTypeVoid());
  ...
  function Spec(entries) {
    ...
    if (typeof entry === "string") {
      this.entries = entries.map(function (s) {
        return _diamnetBase.xdr.ScSpecEntry.fromXDR(s, "base64");
      });
    } else {
  ...
  return _createClass(Spec, [{
    ...
    value: function funcs() {
      return this.entries.filter(function (entry) {
        return entry.switch().value === _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryFunctionV0().value;
      }).map(function (entry) {
    ...
    value: function getFunc(name) {
      ...
      if (entry.switch().value !== _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryFunctionV0().value) {
    ...
    value: function funcResToNative(name, val_or_base64) {
      var val = typeof val_or_base64 === "string" ? _diamnetBase.xdr.ScVal.fromXDR(val_or_base64, "base64") : val_or_base64;
      var func = this.getFunc(name);
      var outputs = func.outputs();
      if (outputs.length === 0) {
        var type = val.switch();
        if (type.value !== _diamnetBase.xdr.ScValType.scvVoid().value) {
      ...
      if (output.switch().value === _diamnetBase.xdr.ScSpecType.scSpecTypeResult().value) {
    ...
    value: function nativeToScVal(val, ty) {
      ...
      var t = ty.switch();
      var value = t.value;
      if (t.value === _diamnetBase.xdr.ScSpecType.scSpecTypeUdt().value) {
        var udt = ty.udt();
        return this.nativeToUdt(val, udt.name().toString());
      }
      if (value === _diamnetBase.xdr.ScSpecType.scSpecTypeOption().value) {
        var opt = ty.option();
        if (val === undefined) {
          return _diamnetBase.xdr.ScVal.scvVoid();
        }
      ...
      switch (_typeof(val)) {
        case "object":
          {
            ...
            if (val instanceof _diamnetBase.xdr.ScVal) {
              return val;
            }
            if (val instanceof _diamnetBase.Address) {
              if (ty.switch().value !== _diamnetBase.xdr.ScSpecType.scSpecTypeAddress().value) {
                throw new TypeError("Type ".concat(ty, " was not address, but value was Address"));
              }
              return val.toScVal();
            }
            if (val instanceof _diamnetBase.Contract) {
              if (ty.switch().value !== _diamnetBase.xdr.ScSpecType.scSpecTypeAddress().value) {
                throw new TypeError("Type ".concat(ty, " was not address, but value was Address"));
              }
                ...
                case _diamnetBase.xdr.ScSpecType.scSpecTypeBytesN().value:
                  {
                    ...
                    return _diamnetBase.xdr.ScVal.scvBytes(copy);
                  }
                case _diamnetBase.xdr.ScSpecType.scSpecTypeBytes().value:
                  return _diamnetBase.xdr.ScVal.scvBytes(copy);
                default:
                ...
                case _diamnetBase.xdr.ScSpecType.scSpecTypeVec().value:
                  {
                    ...
                    return _diamnetBase.xdr.ScVal.scvVec(val.map(function (v) {
                ...
                case _diamnetBase.xdr.ScSpecType.scSpecTypeTuple().value:
                  {
                    ...
                    return _diamnetBase.xdr.ScVal.scvVec(val.map(function (v, i) {
                ...
                case _diamnetBase.xdr.ScSpecType.scSpecTypeMap().value:
                  {
                    ...
                    return _diamnetBase.xdr.ScVal.scvMap(val.map(function (entry) {
                      var key = _this2.nativeToScVal(entry[0], keyType);
                      var mapVal = _this2.nativeToScVal(entry[1], valueType);
                      return new _diamnetBase.xdr.ScMapEntry({
                        key: key,
                        val: mapVal
                      });
                    }));
            ...
            if (val.constructor === Map) {
              if (value !== _diamnetBase.xdr.ScSpecType.scSpecTypeMap().value) {
              ...
              while (!res.done) {
                ...
                entries.push(new _diamnetBase.xdr.ScMapEntry({
                  key: key,
                  val: mapval
                }));
                res = values.next();
              }
              return _diamnetBase.xdr.ScVal.scvMap(entries);
            }
        ...
        case "bigint":
          {
            switch (value) {
              case _diamnetBase.xdr.ScSpecType.scSpecTypeU32().value:
                return _diamnetBase.xdr.ScVal.scvU32(val);
              case _diamnetBase.xdr.ScSpecType.scSpecTypeI32().value:
                return _diamnetBase.xdr.ScVal.scvI32(val);
              case _diamnetBase.xdr.ScSpecType.scSpecTypeU64().value:
              case _diamnetBase.xdr.ScSpecType.scSpecTypeI64().value:
              case _diamnetBase.xdr.ScSpecType.scSpecTypeU128().value:
              case _diamnetBase.xdr.ScSpecType.scSpecTypeI128().value:
              ...
              case _diamnetBase.xdr.ScSpecType.scSpecTypeI256().value:
                {
                  ...
                  return new _diamnetBase.XdrLargeInt(intType, val).toScVal();
                }
              default:
        ...
        case "boolean":
          {
            if (value !== _diamnetBase.xdr.ScSpecType.scSpecTypeBool().value) {
              throw TypeError("Type ".concat(ty, " was not bool, but value was bool"));
            }
            return _diamnetBase.xdr.ScVal.scvBool(val);
          }
        case "undefined":
          {
            if (!ty) {
    ...
    value: function nativeToUdt(val, name) {
      var entry = this.findEntry(name);
      switch (entry.switch()) {
        case _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryUdtEnumV0():
        ...
        case _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryUdtStructV0():
          return this.nativeToStruct(val, entry.udtStructV0());
        case _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryUdtUnionV0():
    ...
    value: function nativeToUnion(val, union_) {
      ...
      var key = _diamnetBase.xdr.ScVal.scvSymbol(entryName);
      switch (caseFound.switch()) {
        case _diamnetBase.xdr.ScSpecUdtUnionCaseV0Kind.scSpecUdtUnionCaseVoidV0():
          {
            return _diamnetBase.xdr.ScVal.scvVec([key]);
          }
        case _diamnetBase.xdr.ScSpecUdtUnionCaseV0Kind.scSpecUdtUnionCaseTupleV0():
          {
            ...
            if (Array.isArray(val.values)) {
              ...
              scvals.unshift(key);
              return _diamnetBase.xdr.ScVal.scvVec(scvals);
            }
    ...
    value: function nativeToStruct(val, struct) {
      ...
      if (fields.some(isNumeric)) {
        ...
        return _diamnetBase.xdr.ScVal.scvVec(fields.map(function (_, i) {
          return _this4.nativeToScVal(val[i], fields[i].type());
        }));
      }
      return _diamnetBase.xdr.ScVal.scvMap(fields.map(function (field) {
        var name = field.name().toString();
        return new _diamnetBase.xdr.ScMapEntry({
          key: _this4.nativeToScVal(name, _diamnetBase.xdr.ScSpecTypeDef.scSpecTypeSymbol()),
    ...
    value: function scValStrToNative(scv, typeDef) {
      return this.scValToNative(_diamnetBase.xdr.ScVal.fromXDR(scv, "base64"), typeDef);
    }
  }, {
    key: "scValToNative",
    value: function scValToNative(scv, typeDef) {
      ...
      var t = typeDef.switch();
      var value = t.value;
      if (value === _diamnetBase.xdr.ScSpecType.scSpecTypeUdt().value) {
        return this.scValUdtToNative(scv, typeDef.udt());
      }
      switch (scv.switch().value) {
        case _diamnetBase.xdr.ScValType.scvVoid().value:
          return undefined;
        case _diamnetBase.xdr.ScValType.scvU64().value:
        case _diamnetBase.xdr.ScValType.scvI64().value:
        case _diamnetBase.xdr.ScValType.scvU128().value:
        case _diamnetBase.xdr.ScValType.scvI128().value:
        case _diamnetBase.xdr.ScValType.scvU256().value:
        case _diamnetBase.xdr.ScValType.scvI256().value:
          return (0, _diamnetBase.scValToBigInt)(scv);
        case _diamnetBase.xdr.ScValType.scvVec().value:
          {
            if (value === _diamnetBase.xdr.ScSpecType.scSpecTypeVec().value) {
              var _scv$vec;
              var vec = typeDef.vec();
            ...
            if (value === _diamnetBase.xdr.ScSpecType.scSpecTypeTuple().value) {
              var _scv$vec2;
              var tuple = typeDef.tuple();
        ...
        case _diamnetBase.xdr.ScValType.scvAddress().value:
          return _diamnetBase.Address.fromScVal(scv).toString();
        case _diamnetBase.xdr.ScValType.scvMap().value:
          {
            var _scv$map;
        ...
        case _diamnetBase.xdr.ScValType.scvBool().value:
        case _diamnetBase.xdr.ScValType.scvU32().value:
        case _diamnetBase.xdr.ScValType.scvI32().value:
        case _diamnetBase.xdr.ScValType.scvBytes().value:
          return scv.value();
        case _diamnetBase.xdr.ScValType.scvString().value:
        case _diamnetBase.xdr.ScValType.scvSymbol().value:
          {
            var _scv$value;
            if (value !== _diamnetBase.xdr.ScSpecType.scSpecTypeString().value && value !== _diamnetBase.xdr.ScSpecType.scSpecTypeSymbol().value) {
        ...
        case _diamnetBase.xdr.ScValType.scvTimepoint().value:
        case _diamnetBase.xdr.ScValType.scvDuration().value:
          return (0, _diamnetBase.scValToBigInt)(_diamnetBase.xdr.ScVal.scvU64(scv.u64()));
        default:
    ...
    value: function unionToNative(val, udt) {
      ...
      if (vec[0].switch().value !== _diamnetBase.xdr.ScValType.scvSymbol().value) {
      ...
      if (entry.switch().value === _diamnetBase.xdr.ScSpecUdtUnionCaseV0Kind.scSpecUdtUnionCaseTupleV0().value) {
        var tuple = entry.tupleCase();
        var ty = tuple.type();
    ...
    value: function enumToNative(scv) {
      if (scv.switch().value !== _diamnetBase.xdr.ScValType.scvU32().value) {
    ...
    value: function errorCases() {
      return this.entries.filter(function (entry) {
        return entry.switch().value === _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryUdtErrorEnumV0().value;
    ...
    value: function jsonSchema(funcName) {
      ...
      this.entries.forEach(function (entry) {
        switch (entry.switch().value) {
          case _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryUdtEnumV0().value:
            {
              var udt = entry.udtEnumV0();
              definitions[udt.name().toString()] = enumToJsonSchema(udt);
              break;
            }
          case _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryUdtStructV0().value:
            {
              var _udt = entry.udtStructV0();
              definitions[_udt.name().toString()] = structToJsonSchema(_udt);
              break;
            }
          case _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryUdtUnionV0().value:
            {
              var _udt2 = entry.udtUnionV0();
              definitions[_udt2.name().toString()] = unionToJsonSchema(_udt2);
              break;
            }
          case _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryFunctionV0().value:
            {
          ...
          case _diamnetBase.xdr.ScSpecEntryKind.scSpecEntryUdtErrorEnumV0().value:
            {}
        }
      });
      var res = {
