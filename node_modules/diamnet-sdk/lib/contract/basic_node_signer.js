      ...
      var _signTransaction = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(tx) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              t = _diamnetBase.TransactionBuilder.fromXDR(tx, networkPassphrase);
              t.sign(keypair);
      ...
      var _signAuthEntry = _asyncToGenerator(_regeneratorRuntime().mark(function _callee2(entryXdr) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", keypair.sign((0, _diamnetBase.hash)(Buffer.from(entryXdr, "base64"))).toString("base64"));
            case 1:
            case "end":
