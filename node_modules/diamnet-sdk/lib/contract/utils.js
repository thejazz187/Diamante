...
function processSpecEntryStream(buffer) {
  var reader = new _diamnetBase.cereal.XdrReader(buffer);
  var res = [];
  while (!reader.eof) {
    res.push(_diamnetBase.xdr.ScSpecEntry.read(reader));
  }
  return res;
}
  ...
  _getAccount = _asyncToGenerator(_regeneratorRuntime().mark(function _callee2(options, server) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", options.publicKey ? server.getAccount(options.publicKey) : new _diamnetBase.Account(_types.NULL_ACCOUNT, "0"));
        case 1:
        case "end":
