import { Networks } from "diamnet-base";
/** the maximum size of diamante.toml file */
export declare const STELLAR_TOML_MAX_SIZE: number;
/** Resolver allows resolving `diamante.toml` files. */
export declare class Resolver {
    /**
     * Returns a parsed `diamante.toml` file for a given domain.
     * ```js
     * DiamSdk.Resolver.resolve('acme.com')
     *   .then(stellarToml => {
     *     // stellarToml in an object representing domain diamante.toml file.
     *   })
     *   .catch(error => {
     *     // diamante.toml does not exist or is invalid
     *   });
     * ```
